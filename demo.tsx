  ...
  publications: [
    {
      ...
      authors: "Hao Zeng*, K Liu*, B Jing, H Wei",
      venue: "ICML 2025",
      type: "Conference",
      year: "2025",
      pdf: "#",
    ...
    },
    {
      ...
      authors: "Hao Zeng, W Zhong, X Xu",
      venue: "Journal of Business & Economic Statistics (JBES)",
      type: "Journal",
      year: "2025",
      pdf: "#",
    },
    {
      ...
      authors: "H Xi, K Liu, Hao Zeng, W Sun, H Wei",
      venue: "NeurIPS 2025",
      type: "Conference",
      year: "2025",
      pdf: "#",
    ...
    },
    {
      ...
      authors: "Hao Zeng*, J Huang*, B Jing, H Wei, B An",
    ...
    },
    {
      ...
      authors: "Hao Zeng, C Wan, W Zhong, T Liu",
...
export default function App() {
  ...
  const MarginNote = ({ children, className = "" }) => (
    <div className={`
      hidden lg:block
  ...
  return (
    <div className={`min-h-screen ${theme.bg} ${theme.text} ${theme.font} transition-colors duration-500 selection:bg-yellow-100 selection:text-black`}>
            ...
            <section id="home" className="relative">
              ...
              <div className="flex flex-col-reverse md:flex-row gap-8 md:items-start justify-between mb-8">
                ...
                `}>
                  ...
                  {/* Image Tag Suggestion (Hidden/Comment-like) */}
                  {/* <img src="/path/to/your/photo.jpg" alt="Hao Zeng" className="absolute inset-0 w-full h-full object-cover" /> */}
                </div>
      ...
      <style>{`
        ...
        body {
          font-family: ${currentTheme === 'paper' ? 'var(--font-serif)' : 'var(--font-sans)'};
        }
